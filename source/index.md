...
<section id="projects" class="projects-section">
    ...
    <div class="projects-grid">
        ...
        <div class="project-card" data-readme="AXI4-Lite 기반 SPI/I2C 통신 프로토콜 설계">
            <div class="project-header">
            ...
            <div class="tech-stack">
                <span class="tech-tag">systemVerilog</span>
                <span class="tech-tag">Vivado</span>
                <span class="tech-tag">Microblaze</span>
...
// 모달 열기 시 스크롤 잠금 (개선된 버전)
function lockScroll() {
  scrollY = window.scrollY || window.pageYOffset;
  
  // 스크롤바 너비 계산 (스크롤바 떨림 방지)
  ...
  document.body.style.paddingRight = `${scrollBarWidth}px`; // 스크롤바 보상
  document.body.style.overflow = 'hidden';
}

// 모달 닫기 시 스크롤 복원 (개선된 버전)
            ...
            if (projectId === 'i2c_vga_videoProcessing') {
                const pdfSection = `
                    ...
                    <div style="text-align: center; padding: 40px; background: #f8f9fa; border-radius: 8px; margin: 20px 0;">
                        ...
                        <h3 style="color: #2c3e50; margin-bottom: 15px;">PDF 문서가 준비 중입니다</h3>
                        <p style="color: #666; margin-bottom: 20px;">
                            현재 VGA_video_processing.pdf 파일이 업로드되지 않았습니다.<br>
                            파일을 업로드하면 여기에 표시됩니다.
                        </p>
                        <div style="background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 6px; padding: 15px; margin: 15px 0;">
                            <strong>📂 업로드 경로:</strong> <code>public/projects/pdf/VGA_video_processing.pdf</code>
                        </div>
                    </div>
                `;
...
function closeReadme() {
  ...
  // 애니메이션 완료 후 스크롤 복원 및 모달 숨기기
  setTimeout(() => {
    unlockScroll(); // 개선된 스크롤 복원 함수 사용
    modal.style.display = 'none';
  }, 300); // CSS 애니메이션 시간에 맞춰 조정
}
