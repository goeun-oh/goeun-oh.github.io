    ...
    <div class="projects-grid">
        ...
        <div class="project-card" data-readme="AXI4-Lite">
            ...
            <h3 class="project-name">AXI4-Lite 기반 SPI/I2C 통신 프로토콜 설계</h3>
                        <!-- 프로젝트 이미지 -->
            <div class="project-image">
                <img src="images/projects/i2c_interface.png" alt="I2C Interface" />
            </div>
            <div class="project-description">
                <ul>
                    <li>AXI4-Lite 기반의 SPI, I2C 통신 프로토콜 구현</li>
                    <li>I2C 기반 보드 간 직렬 통신 인터페이스 설계</li>
                    <li>Synopsys VCS, Verdi를 활용하여 검증</li>
                </ul>
            </div>
            <div class="tech-stack">
        ...
        <div class="project-card" data-readme="RISC-V-Peripheral">
            ...
            <h3 class="project-name"> RISC-V AMBA Peripheral 설계</h3>
                                    <!-- 프로젝트 이미지 -->
            <div class="project-image">
                <img src="images/projects/risc_v_amba.png" alt="I2C Interface" />
            </div>
            <div class="project-description">
                <ul>
        ...
        <div class="project-card" data-readme="single-cycle">
            <div class="project-header">
                <span class="project-title">RISC-V</span>
                <span class="project-date">2025.04.09 - 2025.04.13 (1人 프로젝트)</span>
            </div>
            <h3 class="project-name">RISC-V RV32I 기반 Single Cycle CPU Core 설계</h3>
                                                <!-- 프로젝트 이미지 -->
            <div class="project-image">
                <img src="images/projects/risc-v.png" alt="RISC-V" />
            </div>
            <div class="project-description">
                <ul>
                    <li>RISC-V RV32I 명령어 구조의 Single Cycle CPU 설계</li>
                    <li>R, I, S, B, U, J 타입별 명령어 설계</li>
                    <li>테스트 벤치를 활용한 설계 내용 검증</li>
                </ul>
            </div>
            <div class="tech-stack">
        ...
        <div class="project-card" data-readme="multi-display">
            ...
            <h3 class="project-name">FPGA, UART 통신을 활용한 다기능 디스플레이 모듈 개발</h3>
                                                <!-- 프로젝트 이미지 -->
            <div class="project-image">
                <img src="images/projects/sensor_project.png" alt="seonsor_project" />
            </div>
            <div class="project-description">
                <ul>
                    <li>Basys3 FPGA 보드를 활용하여 시계, 스톱워치, 온습도 및 거리 측정 기능이 통합된 다기능 디스플레이 모듈 개발</li>
                    <li>Basys 3 보드의 버튼과 UART RX 입력을 통한 모듈의 모드 제어</li>
                    <li>FND, PC 화면을 통해 모듈의 출력값 표시</li>
                </ul>
            </div>
            <div class="tech-stack">
        ...
        <div class="project-card" data-readme='python-verification'>
            ...
            <h3 class="project-name">Python 기반의 Verilog 검증 자동화툴 개발</h3>
                                                <!-- 프로젝트 이미지 -->
            <div class="project-image">
                <img src="images/projects/verification_tool.png" alt="verification tool" />
            </div>
            <div class="project-description">
                <ul>
                    <li>Verilog로 작성된 모듈을 자동으로 검증하는 도구 개발</li>
                    <li>Python을 활용하여 입력 값을 자동으로 생성하고, 실제 DUT의 출력과 Python 시뮬레이션의 결과가 동일한지 확인</li>
                    <li>GIT Actions을 활용하여 테스트 모듈을 주기적으로 검사하도록 설정</li>
                </ul>
            </div>
            <div class="tech-stack">
                <span class="tech-tag">verilog, Python, Github, CI/CD</span>
                                   ...
                                   <div class="project-buttons">
            <a href="#" class="btn-minimal" onclick="event.preventDefault(); event.stopPropagation(); openReadme('python-verification')">                <svg width="16" height="16" viewBox="0 0 24 24" fill="#333333">
        <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/>
        </svg>
          자세히보기</a>
            <a href="#" class="btn-minimal" onclick="event.preventDefault(); event.stopPropagation(); openVideoModal('python-verification-video')">🎥 발표 영상</a>
            <a href="#" class="btn-minimal" onclick="event.preventDefault(); event.stopPropagation(); window.open('https://github.com/goeun-oh/Verilog-verification-automation-tool.git', '_blank')">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.30 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                </svg>
                Github
        ...
        <div class="project-card">
            <div class="project-header">
                <span class="project-title">센서 인터페이스 설계</span>
                <span class="project-date">2024.03 - 2024.12 (2人 프로젝트)</span>
            </div>
            <h3 class="project-name">최종 오차 0.01% 미만의 센서 인터페이스 설계 - PCB, FPGA 로직 설계</h3>
                                                <!-- 프로젝트 이미지 -->
            <div class="project-image">
                <img src="images/projects/sensor_interface.png" alt="sensor-interface" />
            </div>
            <div class="project-description">
                <ul>
                    <li>코로나 방전 현상 방지를 위해 UV-C 방사를 안정적으로 감지하고 출력하는 센서 인터페이스 시스템 설계</li>
                </ul>
            </div>
            <div class="tech-stack">
        ...
        <div class="project-card">
            <div class="project-header">
                <span class="project-title">암복호화기</span>
                <span class="project-date">2023.09 - 2023.12 (1人 개인 프로젝트)</span>
            </div>
            <h3 class="project-name">DES/AES 암복호화기 설계</h3>
            <div class="project-description">
                <ul>
                <li>DES(Data Encryption Standard)와 AES(Advanced Encryption Standard) 알고리즘을 기반으로 한 64-bit 암복호화기 설계</li>
                <li>Verilog HDL로 블록 암호 구조를 구현하고, 라운드 함수 및 키 스케줄링 구조 설계</li>
                <li>파이프라인 구조 적용을 통해 초기 설계 대비 처리 속도 27% 향상</li>
                <li>테스트 벤치 및 시뮬레이션을 통해 복호화 일치 여부 검증</li>
                </ul>
            </div>
            <div class="tech-stack">
        ...
        <div class="project-card">
            <div class="project-header">
                <span class="project-title"> 계산기</span>
                <span class="project-date">2023.03 - 2023.06 (1人 개인 프로젝트)</span>
            </div>
            <h3 class="project-name">FPGA 계산기 설계</h3>
            <div class="project-description">
                <ul>
            <li>FPGA 보드(Zynq 기반)를 활용한 4기능 계산기(+, -, ×, ÷) 설계</li>
            <li>FSM(Finite State Machine) 기반의 연산 흐름 제어 로직 구현</li>
            <li>키패드 입력에 따른 상태 전이 및 연산 수행, FND 출력까지 전 과정 설계</li>
            <li>각 게이트 지연 시간 설정을 통해 Setup/Hold Time 및 Glitch 현상 분석 경험</li>
            </ul>
            </div>
            <div class="tech-stack">
        ...
        filterCheckbox.addEventListener('change', function() {
            projectCards.forEach((card, index) => {
                if (this.checked) {
                    ...
                    card.style.display = index < 7 ? 'block' : 'none';
                } else {
                    // 모든 프로젝트 보기
                ...
                const pdfSection = forcePdfDownload ? `
                    ...
                    <div style="width: 100%; height: 70vh; border: 1px solid #e2e8f0; border-radius: 8px; overflow: auto; margin: 20px 0; -webkit-overflow-scrolling: touch; padding: 10px;">
                        <object 
                            ...
                            type="application/pdf" 
                            style="width: 100%; height: 800px;">
                            <p>PDF를 표시할 수 없습니다. <a href="/projects/pdf/multi-display-module.pdf" target="_blank">여기를 클릭하여 PDF 보기</a></p>
                        </object>
                    </div>
                ` : `
                    <hr style="margin: 40px 0; border: none; border-top: 2px solid #e2e8f0;">
...
function closeReadme() {
  ...
  // 300ms 후 완전히 정리
  setTimeout(() => {
    console.log('⏰ setTimeout 실행됨 (300ms 후)');
...
function openVideoModal(projectId) {
    ...
    if (projectId === 'i2c-fpga-game') {
        readmeContent.innerHTML = `
            <div style="text-align: center;">
                <h3>🎥 I2C 통신 기반 듀얼 FPGA 탁구 게임 발표 영상</h3>
                <div style="position: relative; padding-bottom: 56.25%; height: 0; margin: 20px 0;">
                    <iframe 
                        src="https://www.youtube.com/embed/n5QokzeEPyM" 
                ...
                <p style="color: #666; font-size: 0.9rem; margin-bottom: 40px;">
                    📅 2025.06.12 | 4인 팀 프로젝트 발표
                </p>
                
                <!-- 동작 영상 섹션 -->
                <hr style="margin: 30px 0; border: none; border-top: 2px solid #e2e8f0;">
                
                <h3 style="margin-bottom: 30px;">🎮 게임 동작 영상</h3>
                
                <div class="video-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <!-- 1인 게임 -->
                    <div style="text-align: center;">
                        <h4 style="margin-bottom: 15px; color: #2c3e50;">👤 1인 게임 동작 영상</h4>
                        <div style="position: relative; padding-bottom: 56.25%; height: 0;">
                            <iframe 
                                src="https://www.youtube.com/embed/hORD7rTihj4" 
                                style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none; border-radius: 8px;"
                                allowfullscreen
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture">
                            </iframe>
                        ...
                        <p style="color: #666; font-size: 0.8rem; margin-top: 8px;">
                            단일 FPGA 보드에서 패들과 공의 충돌 구현
                        </p>
                    </div>
                    
                    <!-- 2인 게임 -->
                    <div style="text-align: center;">
                        <h4 style="margin-bottom: 15px; color: #2c3e50;">👥 2인 게임 동작 영상</h4>
                        <div style="position: relative; padding-bottom: 56.25%; height: 0;">
                            <iframe 
                                src="https://www.youtube.com/embed/NPWYMMwUaiI" 
                                style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none; border-radius: 8px;"
                                allowfullscreen
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture">
                            </iframe>
    ...
    else if (projectId === 'i2c-video') {
        readmeContent.innerHTML = `
            <div style="text-align: center;">
                <h3>🎥 I2C 기반 보드 간 직렬 통신 인터페이스 설계 발표 영상</h3>
                <div style="position: relative; padding-bottom: 56.25%; height: 0; margin: 20px 0;">
                    <iframe 
    ...
    else if (projectId === 'single-cycle-video') {
        readmeContent.innerHTML = `
            <div style="text-align: center;">
                <h3>🎥 RISC-V RV32I 기반 CPU Core 설계 발표 영상</h3>
                <div style="position: relative; padding-bottom: 56.25%; height: 0; margin: 20px 0;">
                    <iframe 
                        src="https://www.youtube.com/embed/qjp8z9WhDkQ" 
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none; border-radius: 8px;"
                        allowfullscreen
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture">
                    </iframe>
